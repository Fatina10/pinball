...
def move_right(lt, x_b, y_b):
    while lt > 0:
        print("lifeeetimeee:", lt)
        if is_wall(x_b, y_b) and lt >= 1:
            lt = lt - wall_cost
...
def move_down(lt, x_b, y_b, grid_x):
    while lt > 0 and x_b < grid_x:
        print("Moving down...")
        time.sleep(1)
        grids[x_b - 1][y_b - 1] = 0
        grids[x_b][y_b - 1] = 'b'
...
def balls_specs():
    ...
    if balls < 0:
        ...
        for balls in range(0, balls):
            ...
            while lt > 0:
                if dom == 0:
                    move_right(lt, x_b, y_b)

                elif dom == 1:
                    lt, dom = move_up(lt, x_b, y_b)


                elif dom == 2:
                    move_left(lt, x_b, y_b, grid_y)

                elif dom == 3:
                    move_down(lt, x_b, y_b, grid_y)
